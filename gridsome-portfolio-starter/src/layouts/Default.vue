    ...
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        >
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#projects" v-scroll-to="'#projects'" class="text-copy-primary hover:text-gray-600">nCoV-2019</a>
            <g-link v-else to="/#projects" class="text-copy-primary hover:text-gray-600">nCoV-2019</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
